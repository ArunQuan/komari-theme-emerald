...
- Set all four resource percentages to 11px and the foreground color.

## v0.3.2 - 2026-09-23

### Changed

- Matched the CPU usage percentage text size and weight to the CPU label for comparison.
